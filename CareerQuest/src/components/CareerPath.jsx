                ...
                <div className='flex flex-col items-center'>
...

                    {
                        path.map((val,idx)=>{
                            ...
                            return <div className='p-10 rounded-lg bg-white w-300 my-10 flex flex-col justify-center hover:scale-105 duration-300'>
                                {newStage && <>
                                    <h1 className="text-teal-600 text-2xl md:text-3xl font-poppins font-bold h-10 p-5">{val.stage}</h1>
                                    <hr className="w-1/3 border-t-2 border-teal-500 my-10  w-full rounded-md" />
                                </>}
                                <h2 className="text-xl md:text-2xl font-poppins font-bold h-10 p-5">{val.title}</h2>
                                <p className='p-5 text-xl font-poppins font-semibold'>{val.description}</p>
