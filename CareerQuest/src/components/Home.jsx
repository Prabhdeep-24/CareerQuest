...
function Home() {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-100 min-h-screen">
      <div className="w-full flex flex-col items-center pt-24 pb-16 bg-gradient-to-r from-blue-900 to-emerald-600 text-white px-4 md:px-24">
        <h1 className="text-3xl md:text-5xl lg:text-6xl font-poppins font-extrabold text-white mb-6 tracking-tight drop-shadow-lg text-center">
          Discover Your Dream Career
        </h1>
        <p className="text-base md:text-lg lg:text-xl text-gray-200 mb-8 text-center font-poppins leading-relaxed max-w-3xl">
          Let Career Quest guide you to in-demand careers based on your
          passions!
        </p>
        <Link to="/Form">
          <button className="cursor-pointer bg-teal-600 text-white px-8 md:px-10 py-3 md:py-4 rounded-lg font-poppins font-semibold text-base md:text-lg hover:bg-teal-700 transition-all duration-300 shadow-lg">
            Get Started
          </button>
        </Link>
      </div>

      <div className="introduction px-6 md:px-20 mt-10 mb-12 max-w-5xl">
        <h1 className="text-2xl md:text-3xl font-poppins font-bold text-gray-800 mb-4 tracking-tight text-center md:text-left">
          Introduction
        </h1>
        <p className="text-sm md:text-base lg:text-lg text-gray-700 font-poppins leading-relaxed text-justify">
      ...
      <h1 className="text-2xl md:text-3xl font-poppins font-bold text-gray-800 mb-6 tracking-tight text-center">
        Famous Career Options
      </h1>
      <div className="flex flex-col items-center w-full gap-12 px-6 md:px-20">
        <p className="text-sm md:text-base lg:text-lg max-w-3xl text-gray-700 font-poppins leading-relaxed text-center">
        ...
        {region === "India" ? (
          <div>
            <div className="flex justify-center gap-6 py-8">
              <button
                className="cursor-pointer bg-teal-600 text-white px-5 md:px-6 py-2 rounded-lg font-poppins font-semibold text-sm md:text-base hover:bg-teal-700 transition-all duration-300 shadow-md"
                onClick={() => setRegion("India")}
              >
                India
              </button>
              <button
                className="cursor-pointer bg-gray-200 text-gray-700 px-5 md:px-6 py-2 rounded-lg font-poppins font-semibold text-sm md:text-base hover:bg-teal-100 transition-all duration-300"
