...
function Navbar() {
  return (
    <div className='flex px-14 py-4 items-center h-20 w-full gap-16 bg-gradient-to-r from-gray-900 via-deep-blue to-gray-900 sticky top-0 z-20 shadow-xl border-b border-teal-700/30'>
        ...
        <Link to="/" className='text-teal-100 font-poppins text-xl font-semibold tracking-wide hover:text-bright-yellow hover:scale-105 transition-all duration-300 cursor-pointer'>Professions</Link>
